...
import type { LogWriterPort } from './ports/log-writer.port';
import type { RealtimePublisherPort } from './ports/realtime-publisher.port';
...
describe('LogEventProcessorService', () => {
  ...
  beforeEach(() => {
    ...
    const logWriter = { indexLog } as LogWriterPort;
    const realtimePublisher = { publish } as RealtimePublisherPort;
